...
function renderResults(results) {
  ...
  const content = results
    .map((item, index) => {
      ...
      const imagePath = `https://davidmckeygarcia.github.io/LOLDOKU/Images/Champions/${championName}Square.png`;
    ...
    if (isCorrect) {
      ...
      img.onload = function() {
        ...
        requestAnimationFrame(() => {
          gridItems[index].style.backgroundImage = `url('https://davidmckeygarcia.github.io/LOLDOKU/Images/Champions/${championName}Square.png')`;
        });
...
function initializeGrid() {
  ...
  gridItems.forEach((item, index) => {
    ...
    if (correctSquares[index]) {
      ...
      item.style.backgroundImage = `url('https://davidmckeygarcia.github.io/LOLDOKU/Images/Champions/${championName}Square.png')`;
